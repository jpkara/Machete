...
namespace Machete.Test
{
    public class IISExpress
    {
        ...
        public IISExpress(string project, string port)
        {
            _project = project;
            _port = port;
        }
        ...
        {
            var applicationPath = GetApplicationPath(_project);
            ...
            var startInfo = new ProcessStartInfo
            {
                ...
                Arguments = string.Format("/path:\"{0}\" /port:{1}", applicationPath, _port)
            };
